...
class Pedido(Base):
    ...
    avaliacao_pedido: Mapped[Optional["AvaliacaoPedido"]] = relationship("AvaliacaoPedido", back_populates="pedido", uselist=False)
    itens_pedido: Mapped[list["ItemPedido"]] = relationship("ItemPedido", back_populates="pedido")
